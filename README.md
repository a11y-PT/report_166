---
website: "Município de Manteigas"          # Entre as aspas escreve o nome do website
date: "20/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://cm-manteigas.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://cm-manteigas.pt/acessibilidade/" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Município de Manteigas"         # Entre as aspas escrever o nome do owner do website
